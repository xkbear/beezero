              ...
              <div className="w-full max-w-4xl mx-auto mb-8">
                ...
                <div className="flex flex-row gap-8 justify-center items-center mb-2 flex-wrap">
                  <div className="flex flex-col items-center">
                    <img src={`${import.meta.env.BASE_URL}mytraqr.png`} alt="mytraqr demo" className="w-96 h-56 object-cover rounded-xl shadow-md border border-gray-200 mb-2" />
                  ...
                  <div className="flex flex-col items-center">
                    <img src={`${import.meta.env.BASE_URL}aloft.png`} alt="aloft demo" className="w-96 h-56 object-cover rounded-xl shadow-md border border-gray-200 mb-2" />
